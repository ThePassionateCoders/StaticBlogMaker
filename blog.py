...
if __name__=="__main__":	
	...
	while len(userInputs["sitename"])>20 or len(userInputs["sitename"])<5 :
		userInputs["sitename"]=ask("\nPlese Give Blog Name in Range of 5 to 20 characters")
	...
	userInputs["bgimg"]=ask("Give two words that best describes type of your blog(These will be used to get background image of page). Seprate using comma.(Example: technology,programming)")
	...
	while len(pageInputs['pagedesc'])<100 or len(pageInputs['pagedesc'])>150 :
		pageInputs["pagedesc"]=ask("Page Description shoud be more than 100 characters and less then 150 characters.")
	      ...
	      <div class="row">
	        <div class="col-lg-8 col-md-10 mx-auto">
	          <div class="site-heading">
	            <h1 style="font-size:6vw">{userInputs['sitename']}</h1>
